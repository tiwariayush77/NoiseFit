...
<div className="space-y-5">
  <div className="mb-4">
    <h2 className="text-lg font-bold text-white mb-2">Score Components</h2>
  ...
  {components.map((component, idx) => (
    <button
      ...
      className={`
        w-full bg-gradient-to-br ${component.bgColor} 
        border-2 ${component.borderColor} 
        hover:border-opacity-70
        rounded-2xl p-5 text-left transition-all cursor-pointer group
      `}
    >
      {/* Header Row */}
      ...
      {/* Weight Badge */}
      <div className="mb-3">
        <span className={`inline-block px-3 py-1 rounded-full border ${component.borderColor} ${component.textColor} bg-card/50 text-xs font-semibold`}>
          {component.weight}% of total score
        </span>
      </div>
      
      {/* Explanation */}
      <div className="bg-card/40 rounded-lg p-3 mb-3">
...
<div className="bg-primary/10 border-2 border-primary/30 rounded-2xl p-6">
  ...
  <div className="bg-card/50 border border-border/20 rounded-xl p-5">
    <div className="font-mono text-sm text-muted-foreground space-y-2.5">
      ...
      <div className="border-t-2 border-primary/30 my-3 pt-3">
