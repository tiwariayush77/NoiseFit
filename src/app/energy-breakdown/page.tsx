...
<div className="space-y-5">
  ...
  {components.map((component, idx) => (
    <button
      ...
      className={`w-full bg-gradient-to-br ${component.bgColor} border-2 ${component.borderColor} hover:border-opacity-70 hover:bg-opacity-80 rounded-2xl p-5 text-left transition-all cursor-pointer group`}
    >
      {/* Header Row */}
...
{/* Weight Badge */}
<div className="mb-3">
  <div className={`inline-block px-3 py-1 rounded-full border ${component.borderColor} ${component.textColor} bg-card/50`}>
...
{/* Explanation Box */}
<div className="bg-card/40 border border-border/50 rounded-lg p-3 mb-3">
